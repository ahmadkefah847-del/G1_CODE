        ...
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-red-500 text-white hover:bg-red-600 transition"><span>⎋</span><span><?php echo e(__('dashboard.actions.logout')); ?></span></button>
                </form>
            </div>
        </div>
...
<?php /**PATH C:\Users\a3m20\OneDrive\Desktop\saqqia\resources\views/dashboard/user-dashboard.blade.php ENDPATH**/ ?>